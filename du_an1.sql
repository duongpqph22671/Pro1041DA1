...
insert into khachHang(tenKhachHang, gioiTinh, sdt,ngayThem,trangThai)
		values(N'Khach Vang Lai',1,'000000000', GETDATE(),1),
			(N'Nguyen Minh Tu',1,'0334921271', GETDATE(),1),
...
insert into nxb(tenNhaXuatBan)
		VALUES  (N'NXB Tuoi Tre'),
				(N'NXB Kim Dong'),
				(N'NXB PHu Nu')
...
insert into CTKM_HoaDon(tenCTKM, giaTriGiam, soLuong, ngayBatDau,ngayKetThuc, trangThai,hoaDonToiThieu)
			values	(N'Không Dùng', 0, 99999, GETDATE(),GETDATE()+3, 1,0),
