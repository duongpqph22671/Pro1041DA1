...
public class QuanLyHoaDonChiTiet {
    ...
    public Object[] addRowHDCT(){
        return new Object[]{id_HoaDonChiTiet,id_HoaDon,id_SanPhamChiTiet,currencyFormat.format(giaBan),soLuong,ghiChu};
    }

    public QuanLyHoaDonChiTiet(int id_HoaDonChiTiet, int id_HoaDon, String id_SanPhamChiTiet, double giaBan, int soLuong, String ghiChu) {
    ...
    public String toString() {
        return "QuanLyHoaDonChiTiet{" + "id_HoaDonChiTiet=" + id_HoaDonChiTiet + ", id_HoaDon=" + id_HoaDon + ", id_SanPhamChiTiet=" + id_SanPhamChiTiet + ", giaBan=" + giaBan + ", soLuong=" + soLuong + ", ghiChu=" + ghiChu + '}';
    }
