...
public class HoaDonModel {
    ...
    public Object[] addRow() {
        return new Object[]{id_hoaDon, id_KhachHang, id_NhanVien, currencyFormat.format(tienHang), currencyFormat.format(chietKhau), currencyFormat.format(tongTien), ngayTao, ngaySua, trangThai == true ? "Đã Thanh Toán" : "Chưa Thanh Toán"};
    }
