...
//                }
                ...
                if (chon == JOptionPane.YES_OPTION) {
                    ...
                    int idKm = km.getId_CTKM_HoaDon();
                    int vtHTTT = cbo_thanhToan.getSelectedIndex();
                    System.out.println(vtHTTT);
                    ...
                    inHoaDon();
                    int idHoaDon = Integer.parseInt(txt_maHoaDon.getText());
                    if (service.updateHoaDon(idKm, hinhThucThanhToan, tongTien, tienGiam, thanhTien, idHoaDon, idKh) != null) {
...
//    }
    ...
    public void fillTableHoaDon() {
        ...
        for (BanHangHoaDonCho kh : service.getAllHoaDonCho()) {
            ...
            molHoaDon.addRow(new Object[]{kh.getId(), kh.getTenNhanVien(), kh.getTenKhachHang(), kh.getNgayTao(), kh.isTrangThai() == true ? "Da Thanh Toan" : "Cho Thanh Toan"});
        }
    }
